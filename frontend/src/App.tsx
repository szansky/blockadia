...
const App = () => {
  ...
  useEffect(() => {
    ...
    const handleOpenVillage = ((e: CustomEvent<{ id: string, level: number, type?: string, isUpgrading: boolean, upgradeProgress: number, isRecruiting: boolean, recruitProgress: number }>) => {
    ...
    const handleBuildingUpdate = ((e: CustomEvent<{ id: string, level: number, isUpgrading: boolean, upgradeProgress: number, isRecruiting: boolean, recruitProgress: number }>) => {
  ...
  }, [selectedBuildingId]); // Re-bind if selection changes (though logic inside handles it)

  // Simulation logic removed - handled by Phaser now
              ...
              <div className="grid grid-cols-2 gap-8 relative z-10">
                      ...
                      <div className="bg-slate-950/50 rounded-lg p-3 border border-slate-800 w-full">
                        ...
                        <div className="flex justify-center gap-4">
                          <div className={`flex items-center gap-1 ${resources.wood < 200 ? 'text-red-400' : 'text-green-400'}`}>
                            <img src="/assets/tree.png" className="w-4 h-4" alt="Wood" /> <span className="font-mono font-bold">200</span>
                          </div>
                          <div className={`flex items-center gap-1 ${resources.stone < 100 ? 'text-red-400' : 'text-green-400'}`}>
                            <img src="/assets/stone.png" className="w-4 h-4" alt="Stone" /> <span className="font-mono font-bold">100</span>
                          </div>
                          <div className={`flex items-center gap-1 ${resources.gold < 50 ? 'text-red-400' : 'text-green-400'}`}>
                            <img src="/assets/gold.png" className="w-4 h-4" alt="Gold" /> <span className="font-mono font-bold">50</span>
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="rounded-xl border-2 border-slate-700 bg-slate-800/50 p-6 flex flex-col items-center gap-4 hover:border-blue-500/50 transition-all">
                  ...
                  <div className="w-24 h-24 bg-slate-900 rounded-full border-4 border-slate-700 flex items-center justify-center shadow-inner relative">
                    <img src="/assets/villager.png" alt="Villager" className="w-16 h-16 object-contain drop-shadow-md" />
                    ...
                    <div className="bg-slate-950/50 rounded-lg p-3 border border-slate-800 w-full">
                      ...
                      <div className="flex justify-center gap-4">
                        <div className={`flex items-center gap-1 ${resources.gold < 10 ? 'text-red-400' : 'text-green-400'}`}>
                          <img src="/assets/gold.png" className="w-4 h-4" alt="Gold" /> <span className="font-mono font-bold">10</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={() => setIsBuildModalOpen(false)}>
            <div className="bg-slate-900 border-2 border-slate-700 rounded-xl p-4 flex gap-4 shadow-2xl" onClick={e => e.stopPropagation()}>
              <button
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors border border-slate-600 hover:border-amber-500"
              >
                <div className="w-16 h-16 bg-slate-900 rounded flex items-center justify-center overflow-hidden border border-slate-700">
                  <img src="/assets/village.png" className="w-full h-full object-contain" alt="Village" />
                </div>
          ...
          <div className="absolute top-4 left-0 right-0 flex justify-center z-10 pointer-events-none">
            <div className="bg-slate-950/90 border-2 border-slate-700 rounded-lg p-2 px-6 flex gap-8 pointer-events-auto shadow-2xl backdrop-blur-md">
              ...
              <div className="flex items-center gap-3">
                <img src="/assets/tree.png" alt="Wood" className="w-8 h-8 object-contain drop-shadow-md" />
              ...
              {/* Stone */}
              <div className="flex items-center gap-3">
                <img src="/assets/stone.png" alt="Stone" className="w-8 h-8 object-contain drop-shadow-md" />
                <div className="flex flex-col">
              ...
              {/* Gold */}
              <div className="flex items-center gap-3">
                <img src="/assets/gold.png" alt="Gold" className="w-8 h-8 object-contain drop-shadow-md" />
                <div className="flex flex-col">
              ...
              {/* Metal */}
              <div className="flex items-center gap-3">
                <img src="/assets/metal.png" alt="Metal" className="w-8 h-8 object-contain drop-shadow-md" />
                <div className="flex flex-col">
